import { BookOpen, Heart, Search, ArrowRight, Loader2 } from 'lucide-react'
...
export default function Livres() {
  ...
  const filtered = useMemo(() => books.filter((book) => {
    ...
    return text.includes(query.toLowerCase()) && (category === 'Tous' || book.category === category)
